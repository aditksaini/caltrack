...
import { History, X, Calendar, ChevronRight, Activity, Flame } from 'lucide-react';
                                ...
                                log.foods.map((food, idx) => (
                                  <div key={idx} className="flex justify-between items-center text-sm border-b border-white/5 pb-2 last:border-0 last:pb-0">
                                    <div className="flex-1">
                                      <p className="text-white/80 font-medium truncate pr-4">{food.name}</p>
                                      <p className="text-white/40 text-[10px] mt-0.5">{food.quantity_description}</p>
                                    </div>
